...
#plot
interact_plot(lm1, pred=Age, modx=Symptoms, plot.points=TRUE, point.alpha=0.2, interval = TRUE, int.type = "confidence", int.width = .95)
...
ggboxplot(season_data_RV, x = "Genotype", y = "Ct") + theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 8))

#Genotypes with more than 5 cases detected, versus Ct value
ggboxplot(season_data_RV_CT.5, x = "Genotype", y = "Ct") + theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 8))
